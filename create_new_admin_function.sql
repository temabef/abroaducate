-- Create a brand new admin function that definitely works

-- Drop the problematic function
DROP FUNCTION IF EXISTS public.is_admin();

-- Create a simple, bulletproof admin function
...
SELECT public.is_admin() as new_function_result;

-- Also test each condition individually to see what's happening
SELECT 
  auth.uid() as your_id,
