...
-- Test 9: Test the public view
SELECT 'Test 9: Public View Test' as test_name;

-- Check the public view returns decoded data
SELECT 
  title,
  provider,
  amount,
...
-- Test 10: Performance test with levels index
...
-- Test 11: Cleanup (optional - uncomment to remove test data)
-- SELECT 'Test 11: Cleanup' as test_name;
