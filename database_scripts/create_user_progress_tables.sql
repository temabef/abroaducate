...
-- ========================================
-- This script creates tables to track user progress in test prep

-- 1. Create user_practice_attempts table
...
-- 2. Create user_practice_responses table for individual question responses
...
-- 3. Create user_test_sessions table for overall test sessions
...
-- 6. Create RLS policies for user_practice_attempts
...
-- 7. Create RLS policies for user_practice_responses
...
-- 8. Create RLS policies for user_test_sessions
...
-- 9. Create function to get user progress summary
...
-- 10. Create function to calculate user performance
...
-- 12. Create function to get user's current progress
