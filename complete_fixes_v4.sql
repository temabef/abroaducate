-- ============================================================================
-- COMPLETE FIX FOR VERSION HISTORY AND INLINE EDITING (V4)
-- Fixed to drop existing functions first
...
DROP FUNCTION IF EXISTS check_and_increment_inline_edits(UUID, INTEGER);
DROP FUNCTION IF EXISTS get_inline_editing_usage(UUID);
...
-- Test the inline editing function (this will show current plan and limits)
SELECT * FROM get_inline_editing_usage('f443d194-4b56-48da-9251-6c3f790f0f33');
...
BEGIN
  ...
  RAISE NOTICE '🔧 Existing functions dropped and recreated with correct signatures';
