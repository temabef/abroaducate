-- Fix application_method constraint and add missing graduate funding fields
...
COMMENT ON TABLE scholarships IS 'Scholarships and funding opportunities including traditional scholarships, graduate program funding, and advertised research positions'; 