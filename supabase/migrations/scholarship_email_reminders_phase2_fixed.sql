-- =============================================
-- Phase 2: Email Reminders & Calendar Integration (FIXED)
-- =============================================
...
-- 5. CREATE Reminders Table (Full Creation)
CREATE TABLE IF NOT EXISTS reminders (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE,
    type VARCHAR(30) DEFAULT 'custom' CHECK (type IN ('deadline', 'milestone', 'custom', 'document')),
    title TEXT NOT NULL,
    message TEXT,
    reminder_date TIMESTAMPTZ NOT NULL,
    application_id TEXT, -- Can reference scholarship applications
    event_id TEXT, -- For calendar integration
