...
export const GET: RequestHandler = async ({ url }) => {
    try {
        ...
        const transformedUniversities = universities.map(uni => ({
            ...
            country: uni.country,
            region: uni.region,
            ranking: typeof uni.global_ranking === 'number' ? uni.global_ranking : 999, // keep explicit, but avoid misleading
            acceptance_rate: typeof uni.acceptance_rate === 'number' ? uni.acceptance_rate : null,
            avg_gpa: typeof uni.avg_gpa === 'number' ? uni.avg_gpa : null,
            strengths: uni.strengths,
            programs: uni.programs,
            requirements: uni.requirements,
            cost: uni.cost,
            living_cost: typeof uni.living_cost === 'number' ? uni.living_cost : null,
            scholarships: !!uni.scholarships,
            scholarship_percentage: typeof uni.scholarship_percentage === 'number' ? uni.scholarship_percentage : null,
            ...
            state: uni.state,
            city: uni.city,
            student_size: typeof uni.student_size === 'number' ? uni.student_size : null,
            ownership_type: uni.ownership_type,
            median_debt: typeof uni.median_debt === 'number' ? uni.median_debt : null,
            graduate_earnings: typeof uni.graduate_earnings === 'number' ? uni.graduate_earnings : null,
