...
export const POST: RequestHandler = async ({ request, locals: { supabase } }) => {
	try {
		...
		if (profileError) {
			...
			console.log(`[WELCOME] Created user_profiles for ${userId}`);
		}
...
<p>You've joined 5,000+ students using Abroaducate to find low-tuition programs and scholarships across Europe. Everything on Abroaducate is <strong>100% Free</strong> — no credit limits or subscriptions, ever.</p>
...
<tr><td class="icon-cell" style="color:#f97316;font-size:18px;">&#9679;</td><td><span class="label">AI Document Generation</span><br><span class="desc">Draft SOPs, cover letters, and personal statements.</span></td><td style="text-align:right"><span class="badge free">Free</span></td></tr>
<tr><td class="icon-cell" style="color:#f97316;font-size:18px;" style="border:none">&#9679;</td><td style="border:none"><span class="label">Relocation Toolkit</span><br><span class="desc">Embassy-approved blocked accounts, health insurance, and eSIMs.</span></td><td style="text-align:right;border:none"><span class="badge free">Free</span></td></tr>
</table></div>
<p style="color:#64748b;font-size:13px;">Our platform is completely free for all students. We partner directly with relocation service providers (like German Blocked Accounts and Health Insurance) to keep Abroaducate open to all.</p>
<hr class="divider">
...
<a href="https://abroaducate.com/newsletter/unsubscribe" style="color:#f97316;text-decoration:underline;font-weight:600;">Unsubscribe</a> &middot; <a href="https://abroaducate.com/privacy" style="color:#f97316;text-decoration:underline;font-weight:600;">Privacy Policy</a>
			...
			text: `Welcome to Abroaducate!\n\nEverything on Abroaducate is 100% Free — no credit limits, cards, or subscriptions required.\n\nWhat you can do:\n- Browse 2,500+ programs (free)\n- Scholarship matching (free)\n- AI Document Generator (free)\n- Relocation & visa toolkit (free)\n\nGet started: https://abroaducate.com/programs\n\nQuestions? Reply to this email.`
		});
