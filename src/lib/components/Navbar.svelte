      ...
      <div class="relative">
        ...
        {#if nextStepsDropdownOpen}
          <div class="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 py-2">
            ...
            <a href="/budget-calculator" class="flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition duration-200">
              <span class="text-lg mr-3">💰</span>
              <div>
      ...
      <div class="px-4 py-2 space-y-1">
        ...
        <details class="group">
          ...
          <div class="pl-4 space-y-1">
            ...
            <button onclick={() => navigateTo('/budget-calculator')} class="block w-full text-left py-2 text-gray-300 hover:text-white transition duration-300 bg-transparent border-none">Budget Calculator</button>
