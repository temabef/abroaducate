...
export const DUTCH_UNIVERSITIES: DutchUniversityData[] = [
    ...
    },
    {
        ...
        language: 'bilingual',
        research_intensity: 'medium',
        notable_programs: ['Business Administration', 'MBA', 'Accounting', 'Finance', 'Management'],
        strengths: ['business-excellence', 'executive-education', 'networking', 'castle-campus'],
